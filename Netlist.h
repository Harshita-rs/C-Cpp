...
typedef std::list<pin_list> pin_lit_;
pin_lit_ plist;
...
bool create_connects(const evl_components &components, const string_list &nets_list_, gate_pin_map &gate_pin_map_, pins_list &pins_list_, pin_lit_  &pllist);
...
void netlist_write(std::ostream &out, const evl_components &components, const evl_modules &modules);
